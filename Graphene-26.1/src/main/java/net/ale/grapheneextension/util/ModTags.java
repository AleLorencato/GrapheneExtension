...
public class ModTags {
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return BlockTags.create(Identifier.fromNamespaceAndPath(GrapheneExtension.MOD_ID, name));
        }
    ...
    public static class Items {
        ...
        public static final TagKey<Item> REPAIRS_GRAPHENE_ARMOR = tag("repairs_graphene_armor");

        private static TagKey<Item> tag(String name) {
            return ItemTags.create(Identifier.fromNamespaceAndPath(GrapheneExtension.MOD_ID, name));
        }
