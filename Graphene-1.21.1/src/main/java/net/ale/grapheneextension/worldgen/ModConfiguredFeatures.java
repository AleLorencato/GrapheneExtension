...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldGrapheneOres = List.of(
                OreConfiguration.target(stoneReplaceable, ModBlocks.GRAPHENE_ORE.get().defaultBlockState()),
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(GrapheneExtension.MOD_ID, name));
    }
